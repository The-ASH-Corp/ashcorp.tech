  ...
  return (
    <div className="md:flex block md:w-[80%] mx-auto w-[90%] mb-16">
      ...
      <div className="pl-4 border-l-2 md:mt-0 mt-5 md:w-[35%]">
        ...
        Creating software applications for mobile, web, or desktop platforms, encompassing design, coding, testing, and deployment, catering to user needs.
        </p>
      </div>
      <div className="md:w-[20%] md:h-auto flex md:items-center md:justify-center">
        <Link to={"/courses"}>
          <button className="font-semibold mt-5 md:mt-0 py-2 px-4 rounded-[20px] bg-[#d326ed] text-[15px] text-white hover:bg-black duration-500">
            VIEW ALL COURSES
          </button>
        </Link>
      </div>
