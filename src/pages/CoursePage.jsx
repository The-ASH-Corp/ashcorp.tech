    ...
    <div>
      ...
      <div className="w-full mt-[100px]">
        <div className="md:w-[80%] w-[90%] grid grid-flow-row grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mx-auto mb-[50px]">
          <div className="md:h-[450px] mt-[50px] shadow-2xl rounded-[10px] overflow-hidden transform transition duration-500 hover:scale-[1.1]">
          ...
          <div className="md:h-[450px] mt-[50px] shadow-2xl rounded-[10px] overflow-hidden transform transition duration-500 hover:scale-[1.1]">
            ...
            <h1 className="text-[30px] font-bold w-full text-center py-5 p-[2px]">
              {" "}
              Backend Development
            </h1>
            <p className="px-[15px] text-center">
